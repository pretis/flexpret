...
void ready_queue_add(int (*task)(), char priority, char id) {
...
int taskB4_main(void);
int taskB5_main(void);
int taskB6_main(void);
int taskB7_main(void);
...
void handler()
{
    ...
    switch (tick) {
        case 0:
            ready_queue_add(taskB4_main, 0, 4);
            ready_queue_add(taskB5_main, 0, 5);
            ready_queue_add(taskB6_main, 1, 6);
            ready_queue_add(taskB7_main, 2, 7);
            break;
        case 1:
            ready_queue_add(taskB4_main, 0, 4);
            ready_queue_add(taskB5_main, 0, 5);
