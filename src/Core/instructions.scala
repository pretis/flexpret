...
object Instructions
{
  ...
  val CLEARPCR   = Bits("b?????_?????_????????????_000_1111011",32);
  val SETPCR     = Bits("b?????_?????_????????????_001_1111011",32);
  val MFPCR      = Bits("b?????_?????_00000_0000000010_1111011",32);
  val MTPCR      = Bits("b?????_?????_?????_0000000011_1111011",32);
  ...
  // vector instructions
  val FENCE_V_L  = Bits("b?????_?????_????????????_100_0101111",32);
  val FENCE_V_G  = Bits("b?????_?????_????????????_101_0101111",32);
  ...
  val VENQCMD    = Bits("b00000_?????_?????_0001010110_1111011",32)
  val VENQIMM1   = Bits("b00000_?????_?????_0001011110_1111011",32)
  val VENQIMM2   = Bits("b00000_?????_?????_0001100110_1111011",32)
  val VENQCNT    = Bits("b00000_?????_?????_0001101110_1111011",32)
  val VXCPTKILL  = Bits("b00000_00000_00000_0000010110_1111011",32)
  ...
  // PRET instructions
  //val DMA_CH     = Bits("b00000_?????_?????_??????_1000_1011011",32);
  //val DMA_LD     = Bits("b00000_?????_?????_??????_1001_1011011",32);
  //val DMA_ST     = Bits("b00000_?????_?????_??????_1011_1011011",32);
  val GT_L       = Bits("b?????_00000_00000_000000_0000_1011011",32); //ifgt
  val GT_H       = Bits("b?????_00000_00000_000000_0001_1011011",32);
  val DU         = Bits("b00000_?????_?????_000000_0010_1011011",32); //ifdu
  val IE_E       = Bits("b00000_?????_?????_000000_0011_1011011",32);
  val IE_D       = Bits("b00000_00000_00000_000000_0100_1011011",32);
  val TS         = Bits("b00000_00000_00000_000000_0101_1011011",32);
  val ST         = Bits("b00000_?????_?????_000000_0110_1011011",32);
  val SR_N       = Bits("b00000_?????_00000_000000_0111_1011011",32);
  val SR_SUBN    = Bits("b00000_?????_00000_000000_1000_1011011",32);
}
