...
# ---------------------------------------------------------------------------- 
# 100MHz oscillator connected to Y9
...
# JB Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property -dict {PACKAGE_PIN W12 IOSTANDARD LVCMOS33} [get_ports {JBI[0]}];  # "JB1"
set_property -dict {PACKAGE_PIN W11 IOSTANDARD LVCMOS33} [get_ports {JBI[1]}];  # "JB2"
set_property -dict {PACKAGE_PIN V10 IOSTANDARD LVCMOS33} [get_ports {JBI[2]}];  # "JB3"
set_property -dict {PACKAGE_PIN W8 IOSTANDARD LVCMOS33} [get_ports {JBI[3]}];  # "JB4"
set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS33} [get_ports {JBO[0]}];  # "JB7"
set_property -dict {PACKAGE_PIN W10 IOSTANDARD LVCMOS33} [get_ports {JBO[1]}];  # "JB8"
set_property -dict {PACKAGE_PIN V9 IOSTANDARD LVCMOS33} [get_ports {JBO[2]}];  # "JB9"
set_property -dict {PACKAGE_PIN V8 IOSTANDARD LVCMOS33} [get_ports {JBO[3]}];  # "JB10"
